...
export default function ManageServices() {
  ...
  const services = [
	{ title: "Become a Registrar", description: "Verify your domain status", route: "/registrar", color: theme.colors.primary },
  ...
  return (
	<ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
	  <Text style={styles.header}>Registar Section </Text>
